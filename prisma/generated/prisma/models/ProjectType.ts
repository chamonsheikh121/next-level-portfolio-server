...
export type ProjectTypeWhereInput = {
  ...
  id?: Prisma.IntFilter<"ProjectType"> | number
...
export type ProjectTypeScalarWhereWithAggregatesInput = {
  ...
  id?: Prisma.IntWithAggregatesFilter<"ProjectType"> | number
...
export type ProjectTypeOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "title", ExtArgs["result"]["projectType"]>
...
export interface ProjectTypeFieldRefs {
  readonly id: Prisma.FieldRef<"ProjectType", 'Int'>
